...
<template>
  <div id="escape-plan-wrapper">
    ...
    <main role="main">
      <div class="top-text">
        <h2>2. Know what type of building you live in.</h2>
      </div>
      <div class="bottom-images">
        <div class="left-image">
          <div class="image-card-container">
            <image-card
              :img="'living-room/fire-escape-plan/detached_house.png'"
              :text="'Detatched House'"
              :width="'500px'"
              :height="'500px'"
        ...
        <div class="right-text">
          <p>
            If you are on the ground floor, rop to the floor and crawl to the nearest window or door to the outside. <br /><br />
            If you are on an upper floor, drop to the floor and crawl to the nearest window with an emergency ladder. <br /><br />
            Families should practice escaping from upper story windows using portable escape ladders that are stored near the window.
          </p>
        </div>
      </div>
    </main>
